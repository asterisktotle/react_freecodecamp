...
const ShowRecipe = ({ id, name, image, ingredients, showRecipe = false }) => {
	return (
		<div
		...
		>
			...
			<div className={`flex flex-col `}>
				...
				{!showRecipe && (
					<div className="p-3 py-2 self-center text-center cursor-pointer transition-all duration-500 hover:bg-white hover:text-green-600 text-black font-semibold rounded-lg w-[90%]">
						{' '}
						Show recipes
					</div>
				)}
